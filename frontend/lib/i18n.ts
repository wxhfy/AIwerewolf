...
const translations = {
  [Language.ZH]: {
    ...
    brand: "AI Werewolf",
    title: "全局控制台",
    subtitle: "实时房间全局控制台，按阶段展示 AI 对局推进、隐藏身份与关键决策。",
    agentType: "Agent",
    agentMode: "Agent 模式",
    agentHeuristic: "启发式",
    agentLlm: "LLM",
    ...
    viewDescription: "当前固定为全局视角，展示隐藏身份、夜间行动与关键决策，用于 Demo 讲解。",
    streamingLabel: "实时流",
    streamingDescription: "页面通过 SSE 接收有序快照，并支持按序号断线续传。",
    statusReady: "已就绪",
  ...
  [Language.EN]: {
    pageTitle: "AI Werewolf",
    brand: "AI Werewolf",
    title: "Global Console",
    subtitle: "Live global console for AI Werewolf matches, including hidden roles, night actions, and key decisions.",
    agentType: "Agent",
    ...
    viewDescription: "The match UI is fixed to global view for demos, showing roles, night actions, and key decisions.",
    streamingLabel: "Streaming",
    streamingDescription: "The page renders ordered SSE snapshots and resumes by sequence after reconnecting.",
    statusReady: "Ready",
    ...
    exportGameRecord: "Export Game Record",
    retry: "Retry",
    ...
    spectateAndPlay: "Global Match Flow",
    ...
    phases: {
      ...
      DAY_SHERIFF_CLOSING: "Sheriff Closing",
      DAY_VOTE: "Exile Vote",
