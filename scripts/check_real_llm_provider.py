...
def build_preflight(
    raw_models: str = "", *, allow_fake: bool = False, skip_client_check: bool = False
) -> dict[str, Any]:
    ...
    try:
        ...
        result["safe_for_formal_experiment"] = bool(all_available and not has_fake and not skip_client_check)
