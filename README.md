...
> 默认端口：Frontend 3001 / Backend 8000。如果 3001 被占用：
> ```bash
...
`next.config.js` 默认将 API 和 WebSocket 请求代理到 `BACKEND_ORIGIN`（未设置时回退到 `http://127.0.0.1:8000`）：
