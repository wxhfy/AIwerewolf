...
| 策略知识回流 | 从赛后复盘中抽取经验，进入 candidate / active / deprecated 生命周期；Track C Wiki/Hermes 文档说明长期知识编译与候选 patch 的增量设计 | `backend/eval/knowledge_abstractor.py`, `backend/eval/evolution.py`, `docs/TRACK_C_HERMES_LLM_WIKI_DESIGN.md` |
