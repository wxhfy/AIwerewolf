...
完整工程架构图谱见 [`docs/ENGINEERING_ARCHITECTURE.md`](docs/ENGINEERING_ARCHITECTURE.md)。
...
| 策略迭代有生命周期 | Track C 策略先进入候选层，稳定后启用，后续版本可替换旧策略并保留 lineage |
...
| 技术文档 | `docs/ENGINEERING_ARCHITECTURE.md`, `docs/PROJECT_MODULE_DESIGN.md`, `docs/DATA_FLOW.md` |
| 验收材料 | `docs/PROJECT_ACCEPTANCE_REPORT.md`, `docs/backend_acceptance_criteria.md` |
| 数据与结果 | `docs/OPTIMIZATION_BENCHMARK.md`, `docs/PROJECT_FINAL_FACTS.json`, `docs/PROJECT_METHOD_EFFECTIVENESS_FACTS.json` |
...
| [`docs/ARCHITECTURE_DESIGN_GUIDE.md`](docs/ARCHITECTURE_DESIGN_GUIDE.md) | 架构设计、差异化和模块证据索引 |
| [`docs/PROJECT_MODULE_DESIGN.md`](docs/PROJECT_MODULE_DESIGN.md) | 核心模块设计与实现说明 |
| [`docs/DATA_FLOW.md`](docs/DATA_FLOW.md) | 端到端数据流和证据链 |
| [`docs/PRODUCT_TECH_DOC.md`](docs/PRODUCT_TECH_DOC.md) | 产品技术文档 |
| [`docs/PROJECT_ACCEPTANCE_REPORT.md`](docs/PROJECT_ACCEPTANCE_REPORT.md) | 项目总体验收报告 |
| [`docs/TRACK_C_HERMES_LLM_WIKI_DESIGN.md`](docs/TRACK_C_HERMES_LLM_WIKI_DESIGN.md) | Track C 知识进化外循环设计 |
