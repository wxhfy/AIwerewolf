...
def load_docs(conn_str: str = CONN_STR) -> List[Dict]:
    ...
    for sit, rec, rat, role, phase, q, dt in c.fetchall():
        docs.append({
            ...
            "quality": float(q) if q else 0.8, "doc_type": dt or "unknown",
        })
    conn.close()
    return docs
...
def build_test_sets(docs: List[Dict]) -> Dict[str, List[Dict]]:
    ...
    set1 = [
        {"id": "N01", "role": "Seer", "phase": "DAY_BADGE_SPEECH",
         "text": "我是预言家竞选警长需要报警徽流和查验结果", "keywords": ["警徽流", "警长竞选", "报查验"]},
        {"id": "N02", "role": "Witch", "phase": "NIGHT_WITCH_ACTION",
         "text": "第一晚有人被刀我要决定是否使用解药救人", "keywords": ["首夜解药", "解药使用", "救人"]},
        {"id": "N03", "role": "Werewolf", "phase": "NIGHT_WOLF_ACTION",
         "text": "今晚狼队要选择击杀目标应该优先刀谁", "keywords": ["刀人优先级", "刀法", "屠边"]},
        {"id": "N04", "role": "Werewolf", "phase": "DAY_SPEECH",
         "text": "我是狼人需要伪装成好人发言不能被发现", "keywords": ["伪装好人", "狼人伪装"]},
        {"id": "N05", "role": "Villager", "phase": "DAY_SPEECH",
         "text": "我是平民需要给出有价值的发言分析局势", "keywords": ["平民发言", "发言质量"]},
        {"id": "N06", "role": "Hunter", "phase": "DAY_SPEECH",
         "text": "我被多人投票可能要出局要不要跳猎人身份", "keywords": ["猎人跳身份", "枪徽流"]},
        {"id": "N07", "role": "Seer", "phase": "DAY_SPEECH",
         "text": "有人对跳预言家我需要证明自己是真的", "keywords": ["对跳预言家", "查验链"]},
        {"id": "N08", "role": "Werewolf", "phase": "DAY_SPEECH",
         "text": "我被真预言家查杀了应该怎么应对", "keywords": ["被查杀", "反跳预言家"]},
        {"id": "N09", "role": "Witch", "phase": "mid_game",
         "text": "第三天了我有一瓶毒药还没用应该毒谁", "keywords": ["毒药使用", "开毒时机"]},
        {"id": "N10", "role": "Guard", "phase": "NIGHT_GUARD_ACTION",
         "text": "今晚我要守护一个人不能连续守同一个", "keywords": ["守护目标", "轮换守护"]},
        {"id": "N11", "role": "WhiteWolfKing", "phase": "DAY_SPEECH",
         "text": "白狼王什么时候自爆带走关键好人最合适", "keywords": ["白狼王自爆", "自爆时机"]},
        {"id": "N12", "role": "global", "phase": "DAY_VOTE",
         "text": "投票环节怎样分析票型来找到狼人", "keywords": ["票型分析", "冲票"]},
        {"id": "N13", "role": "global", "phase": "late_game",
         "text": "残局只剩3个人怎么做出正确的投票抉择", "keywords": ["残局策略", "残局抉择"]},
        {"id": "N14", "role": "Werewolf", "phase": "DAY_SPEECH",
         "text": "狼队友被怀疑了怎么帮他又不暴露自己", "keywords": ["队友被质疑", "保护队友"]},
        {"id": "N15", "role": "Villager", "phase": "DAY_VOTE",
         "text": "作为平民不确定该投谁怎么正确投票", "keywords": ["平民投票", "投票决定"]},
        {"id": "N16", "role": "global", "phase": "global",
         "text": "我是新手第一次玩狼人杀需要了解基础规则", "keywords": ["新手", "基础规则", "术语"]},
        {"id": "N17", "role": "Witch", "phase": "DAY_SPEECH",
         "text": "我救过一个人银水要不要在白天报出来", "keywords": ["银水", "报银水", "跳身份"]},
        {"id": "N18", "role": "Seer", "phase": "NIGHT_SEER_ACTION",
         "text": "今晚我要验一个人应该优先验谁", "keywords": ["查验选择", "验人优先级"]},
        {"id": "N19", "role": "global", "phase": "mid_game",
         "text": "我发现之前站错边了现在怎么纠正", "keywords": ["站错边", "修正判断"]},
        {"id": "N20", "role": "Werewolf", "phase": "DAY_VOTE",
         "text": "关键时刻需要和狼队友统一冲票推掉一个好人", "keywords": ["冲票", "统一投票", "绑票"]},
    ]
    ...
    for i, d in enumerate(sampled):
        ...
        set2.append({
            "id": sid, "role": d["role"], "phase": d["phase"],
            "text": d["situation"], "keywords": keywords,
    ...
    set3 = [
        # Edge cases
        {"id": "E01", "role": "Seer", "phase": "DAY_SPEECH",
         "text": "我被女巫毒了怎么办", "keywords": ["被毒", "出局", "遗言"]},
        {"id": "E02", "role": "Werewolf", "phase": "NIGHT_WOLF_ACTION",
         "text": "只剩下我一匹狼了该怎么刀人", "keywords": ["最后一狼", "残局", "独狼"]},
        {"id": "E03", "role": "Villager", "phase": "DAY_SPEECH",
         "text": "所有人都说我是狼但我真的是平民", "keywords": ["被冤枉", "自证清白", "表水"]},
        # Ambiguous queries
        {"id": "E04", "role": "global", "phase": "global",
         "text": "这游戏好难我不会玩", "keywords": ["新手", "基础", "入门"]},
        {"id": "E05", "role": "global", "phase": "global",
         "text": "怎样才能赢", "keywords": ["胜利条件", "获胜", "策略"]},
        # Multi-intent queries
        {"id": "E06", "role": "Seer", "phase": "DAY_BADGE_SPEECH",
         "text": "我是预言家第一天查杀了3号但现在有人对跳我该不该报警徽流怎么安排女巫工作", "keywords": ["对跳", "警徽流", "查杀", "女巫"]},
        {"id": "E07", "role": "Werewolf", "phase": "DAY_SPEECH",
         "text": "既要伪装又要带节奏还要保护队友怎么同时做好这些", "keywords": ["伪装", "带节奏", "保护队友"]},
        # Adversarial queries
        {"id": "E08", "role": "Werewolf", "phase": "DAY_SPEECH",
         "text": "好人应该帮狼人隐藏身份投票怎么跟票", "keywords": ["狼人", "伪装", "跟票", "混入"]},
        {"id": "E09", "role": "Villager", "phase": "DAY_SPEECH",
         "text": "我听到旁边有声音这局谁是狼我心里有数", "keywords": ["场外", "贴脸", "违规"]},
        # Role-confused queries
        {"id": "E10", "role": "Witch", "phase": "NIGHT_WITCH_ACTION",
         "text": "我是女巫但我想当预言家那样带队可以吗", "keywords": ["女巫", "带队", "隐藏"]},
        # Very short queries
        {"id": "E11", "role": "global", "phase": "global", "text": "怎么玩", "keywords": ["新手", "入门"]},
        {"id": "E12", "role": "Werewolf", "phase": "global", "text": "自刀", "keywords": ["自刀", "狼人"]},
        # Very long queries
        {"id": "E13", "role": "global", "phase": "mid_game",
         "text": "第一天预言家跳了说查杀5号，5号反跳预言家说查杀8号，8号是女巫跳出来说救了3号银水，现在第二天了场上已经死了两个人分别是预言家和猎人开枪带走了9号，现在需要分析谁是狼人应该投票给谁", "keywords": ["对跳", "多跳", "银水", "死亡分析", "投票"]},
        # Non-standard role queries
        {"id": "E14", "role": "Cupid", "phase": "night_1",
         "text": "丘比特第一晚应该连谁比较好", "keywords": ["丘比特", "情侣", "连人"]},
        {"id": "E15", "role": "BigBadWolf", "phase": "NIGHT_WOLF_ACTION",
         "text": "大野狼额外刀人应该怎么选目标", "keywords": ["大野狼", "额外刀", "双刀"]},
        # Meta-game queries
        {"id": "E16", "role": "global", "phase": "global",
         "text": "如何通过看一个人的表情和动作来判断他是不是狼", "keywords": ["面杀", "抿人", "微表情"]},
        {"id": "E17", "role": "global", "phase": "global",
         "text": "复盘的时候发现自己每局都犯同样的错误怎么改进", "keywords": ["复盘", "学习", "改进"]},
        # Counterfactual queries
        {"id": "E18", "role": "Witch", "phase": "mid_game",
         "text": "我毒错人了毒死了一个平民现在怎么办", "keywords": ["毒错", "救场", "补救"]},
        {"id": "E19", "role": "Werewolf", "phase": "mid_game",
         "text": "刀错人了刀到了一个平民狼刀落后了怎么翻盘", "keywords": ["刀错", "翻盘", "落后"]},
        {"id": "E20", "role": "Guard", "phase": "mid_game",
         "text": "守错人了守了一个狼人导致预言家被刀死了", "keywords": ["守错", "失误", "补救"]},
    ]
...
class BM25Retriever:
    ...
    def search(self, query: str, role: str = "", phase: str = "", k: int = 20) -> List[Dict]:
        ...
        return [{"situation": self.docs[i]["situation"], "strategy": self.docs[i]["strategy"],
                 "quality": self.docs[i]["quality"], "bm25_score": float(scores[i]),
                 "idx": int(i)} for i in top]
...
class DenseRetriever:
    def __init__(self, docs: List[Dict], model_path: str = BGE_PATH, device: str = GPU_DEVICE):
        ...
        self.embeddings = np.asarray(self.model.encode(texts, normalize_embeddings=True, batch_size=32, show_progress_bar=False), dtype=np.float32)

    def search(self, query: str, role: str = "", phase: str = "", k: int = 20) -> List[Dict]:
        qe = np.asarray(self.model.encode(query, normalize_embeddings=True), dtype=np.float32)
        sims = np.dot(self.embeddings, qe)
        rb = np.array([0.15 if d["role"] == role else (0.05 if d["role"] == "global" else 0) for d in self.docs], dtype=np.float32)
        pb = np.array([0.08 if d["phase"] == phase else (0.03 if d["phase"] == "global" else 0) for d in self.docs], dtype=np.float32)
        scores = sims + rb + pb
        top = np.argsort(scores)[::-1][:k]
        return [{"situation": self.docs[i]["situation"], "strategy": self.docs[i]["strategy"],
                 "quality": self.docs[i]["quality"], "dense_score": float(sims[i]),
                 "idx": int(i)} for i in top]
...
class HybridRetriever:
    ...
    def search_rrf(self, query: str, role: str = "", phase: str = "", k: int = 20, rrf_k: int = 60) -> List[Dict]:
        ...
        return [{"situation": self.docs[i]["situation"], "strategy": self.docs[i]["strategy"],
                 "quality": self.docs[i]["quality"], "rrf_score": s, "idx": i}
                for i, s in top]

    def search_weighted(self, query: str, role: str = "", phase: str = "", k: int = 20,
                        bm25_weight: float = 0.3, dense_weight: float = 0.7) -> List[Dict]:
        ...
        return [{"situation": self.docs[i]["situation"], "strategy": self.docs[i]["strategy"],
                 "quality": self.docs[i]["quality"], "hybrid_score": float(combined[i]),
                 "idx": int(i)} for i in top]
...
def run():
    ...
    for set_name, queries in test_sets.items():
        ...
        for method_name, method_func in methods.items():
            ...
            print(f"  {method_name:<18s} P@5={agg['P@5']:.3f} P@10={agg['P@10']:.3f} "
    ...
    for label in metrics_labels:
        ...
        winner_val = np.mean([q[label] for q in combined[winner]]) if label != "latency_ms" else np.mean([q["latency_ms"] for q in combined[winner]])
    ...
    for set_name in test_sets:
        ...
        for mn in method_names:
            ...
            best_in_set = mn == max(method_names, key=lambda m: np.mean([qm["NDCG@5"] for qm in all_results[set_name][m]]))
    ...
    print(f"  * = best method for that metric/test set")
