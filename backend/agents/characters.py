...
PERSONA_POOL: list[dict] = [
    ...
    },
    {
        ...
        "wolf_deception_style": "用自带的话痨节奏掩护狼坑信息",
    ...
    },
    {
        ...
        "wolf_deception_style": "把假命题包装成可证伪的假设",
    ...
    },
    {
        ...
        "wolf_deception_style": "扮演正派审讯者制造道德高地",
    ...
    },
    {
        ...
        "wolf_deception_style": "把真话掺假，让记忆显得权威",
    ...
    },
    {
        ...
        "wolf_deception_style": "用反转叙述包装假身份",
    ...
    },
    {
        ...
        "wolf_deception_style": "用 carry 形象掩护带歪",
    ...
    },
    {
        ...
        "wolf_deception_style": "用工整对账制造可信感",
    ...
    },
    {
        ...
        "wolf_deception_style": "用心理学术语包装伪 insight",
    ...
    },
    {
        ...
        "wolf_deception_style": "用统一战线掩护狼坑",
    ...
    },
    {
        ...
        "wolf_deception_style": "把矛盾包装成诗意混沌",
    ...
    },
    {
        ...
        "wolf_deception_style": "把假设伪装成测试报告",
    ...
    },
    {
        ...
        "wolf_deception_style": "用关怀身份掩护狼队友",
    ...
    },
    {
        ...
        "wolf_deception_style": "用律师身份建立可信度",
    ...
    },
    {
        ...
        "wolf_deception_style": "用可爱形象掩护带节奏",
    ...
    },
    {
        ...
        "speech_length_habit": "短",
        "reasoning_style": "直觉 + 行动优先",
        "social_habit": "带队冲锋",
        "humor_style": "sarcastic",
        "pressure_style": "直接反推 + 比谁更敢站票",
        "uncertainty_style": "选一边压上",
        "wolf_deception_style": "用'保护好人'幌子上分",
    ...
    },
    {
        ...
        "wolf_deception_style": "用矩阵分类制造伪科学",
    ...
    },
    {
        ...
        "wolf_deception_style": "用辩论攻击力掩盖逻辑漏洞",
    ...
    },
    {
        ...
        "wolf_deception_style": "用理论术语制造迷雾",
    ...
    },
    {
        ...
        "wolf_deception_style": "用诗意化的回避混淆视听",
    ...
    },
    {
        ...
        "wolf_deception_style": "用主持人形象制造可信度",
    ...
    },
    {
        ...
        "wolf_deception_style": "用调和姿态拉混票型",
        "mistake_pattern": "过度调和错过出狼时机",
...
def _hydrate_persona(data: dict) -> Persona:
    ...
    persona = Persona(
        ...
        wolf_deception_style=data.get("wolf_deception_style", ""),
...
def build_system_prompt(persona: Persona) -> str:
    ...
    if persona.wolf_deception_style:
        bullets.append(f"扮狼欺骗风格（仅当你是狼时使用）：{persona.wolf_deception_style}。")
    if persona.mistake_pattern:
        bullets.append(f"典型失误：{persona.mistake_pattern}，注意避免。")
