...
| Target-seat Seer paired pipeline pilot | 23 pairs | `PROJECT_TARGET_SEAT_TRACKC_PILOT.json` |
| Target-seat adjusted delta | +6.2817 | `PROJECT_TARGET_SEAT_TRACKC_PILOT.json` |
| Target-seat process delta | +6.1383 | `PROJECT_TARGET_SEAT_TRACKC_PILOT.json` |
| Target-seat role-task delta | +0.0954 | `PROJECT_TARGET_SEAT_TRACKC_PILOT.json` |
...
- Target-seat 23-pair pipeline pilot 已展示正向趋势和链路健康，但 `accepted=false` 且 bootstrap CI 下界跨 0，后续需扩大到 80-120 paired seeds 再作为最终效果确认。
