...
const translations = {
  [Language.ZH]: {
    ...
    brand: "AI Werewolf",
    title: "观战台",
    subtitle: "实时房间观战控制台，可切换普通观众与全局视角，并按阶段查看 AI 对局推进。",
    agentType: "Agent",
    agentMode: "Agent 模式",
    agentHeuristic: "启发式",
    agentLlm: "LLM",
    ...
    viewDescription: "普通观众只看公开进程；全局视角展示隐藏身份、夜间行动与关键决策，用于 Demo 讲解。",
    streamingLabel: "实时流",
  ...
  [Language.EN]: {
    ...
    subtitle: "Live match console for AI werewolf games with audience and global demo views.",
    agentType: "Agent",
    ...
    viewDescription: "Audience view follows public events. Global view reveals roles, night actions, and key decisions for demos.",
