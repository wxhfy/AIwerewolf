...
def load_classic_strategies() -> list[dict]:
    ...
    return [
        # === Seer ===
        {"role": "Seer", "doc_type": "good_play", "phase": "night_1", "priority": "high",
        ...
        {"role": "Seer", "doc_type": "good_play", "phase": "day_1", "priority": "high",
         ...
         "source": "classic_community"},
        {"role": "Seer", "doc_type": "good_play", "phase": "mid_game", "priority": "high",
         "trigger": "面对悍跳狼对跳预言家",
         ...
         "source": "classic_community"},
        # === Witch ===
        {"role": "Witch", "doc_type": "good_play", "phase": "night_1", "priority": "high",
         "trigger": "女巫首夜，收到刀口信息",
         ...
         "source": "classic_community"},
        {"role": "Witch", "doc_type": "good_play", "phase": "mid_game", "priority": "high",
         ...
         "source": "classic_community"},
        {"role": "Witch", "doc_type": "good_play", "phase": "day_1", "priority": "medium",
         ...
         "source": "classic_community"},
        # === Guard ===
        {"role": "Guard", "doc_type": "good_play", "phase": "night_1", "priority": "high",
         ...
         "source": "classic_community"},
        {"role": "Guard", "doc_type": "good_play", "phase": "mid_game", "priority": "high",
         ...
         "source": "classic_community"},
        # === Hunter ===
        {"role": "Hunter", "doc_type": "good_play", "phase": "day_1", "priority": "high",
         "trigger": "猎人前期，身份未暴露",
         ...
         "source": "classic_community"},
        {"role": "Hunter", "doc_type": "good_play", "phase": "late_game", "priority": "high",
         ...
         "source": "classic_community"},
        # === Werewolf ===
        {"role": "Werewolf", "doc_type": "good_play", "phase": "day_1", "priority": "high",
         ...
         "source": "classic_community"},
        {"role": "Werewolf", "doc_type": "good_play", "phase": "night_1", "priority": "high",
         ...
         "source": "classic_community"},
        {"role": "Werewolf", "doc_type": "good_play", "phase": "mid_game", "priority": "medium",
         "trigger": "需要获取信任或逆转劣势",
         ...
         "source": "classic_community"},
        # === Villager ===
        {"role": "Villager", "doc_type": "good_play", "phase": "day_1", "priority": "high",
         ...
         "source": "classic_community"},
        {"role": "Villager", "doc_type": "good_play", "phase": "mid_game", "priority": "high",
         "trigger": "需要判断谁是狼人",
         ...
         "source": "classic_community"},
        {"role": "Villager", "doc_type": "good_play", "phase": "late_game", "priority": "medium",
