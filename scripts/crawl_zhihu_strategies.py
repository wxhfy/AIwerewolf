...
def validate_strategy(item: dict, role: str) -> dict | None:
    ...
    if phase not in valid_phases:
        phase_map = {"night": "NIGHT_ACTION", "night_action": "NIGHT_ACTION",
    ...
    cn2en = {"预言家": "Seer", "女巫": "Witch", "猎人": "Hunter",
...
def generate_for_role(
    client, role: str, count: int, db, dry_run: bool
) -> int:
    ...
    for bi in range(batches):
        ...
        prompt = ZHIHU_PROMPT.format(
            role=role, role_cn=role_cn, count=batch_count,
