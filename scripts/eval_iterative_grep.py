...
if __name__ == "__main__":
    ...
    for mname, mfunc in methods.items():
        ...
        print(
            f"  {mname:<20} P@5={agg['P@5']:.3f} NDCG@5={agg['NDCG@5']:.3f} "
    ...
    print("  Multi-round grep helps when: query has few keywords → results reveal better terms")
    print("  Multi-round grep hurts when: results introduce noise terms that dilute the search")
